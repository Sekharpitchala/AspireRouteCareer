  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full gradient-hero opacity-5 blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-0 left-0 w-1/3 h-1/2 gradient-accent opacity-5 blur-3xl animate-pulse-slow" style={{ animationDelay: "1s" }} />
        ...
        <div className="container mx-auto relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight animate-slide-up" style={{ animationDelay: "100ms" }}>
              ...
              <span className="text-primary animate-text-shimmer bg-gradient-to-r from-primary via-accent to-primary bg-clip-text">AspireRouteCareers</span>
            </h1>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {stats.map((stat, index) => (
              <div key={stat.label} className="text-center animate-fade-up hover-lift" style={{ animationDelay: `${400 + index * 100}ms` }}>
                <div className="text-3xl md:text-4xl font-bold text-primary mb-1 animate-count-up">{stat.value}</div>
